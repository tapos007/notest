...
namespace Nop.Plugin.Widgets.PromoSlider.Data
{
    ...
    public class PromoSliderObjectContext : DbContext, IDbContext
    {
        ...
        {
            modelBuilder.ApplyConfiguration(new PromoSliderRecordMap());
            modelBuilder.ApplyConfiguration(new PromoImageRecordMap());

            modelBuilder.Entity<PromoImageRecord>()
                .HasOne(p => p.PromoSlider)
                .WithMany(b => b.Images)
                .HasForeignKey(p => p.PromoSliderId);
